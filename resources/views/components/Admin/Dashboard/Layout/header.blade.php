...
<div class="z-[9]" id="app_header">
    <div class="app-header z-[999] ltr:ml-[248px] rtl:mr-[248px] bg-white dark:bg-slate-800 shadow-sm dark:shadow-slate-700">
        <div class="flex justify-between items-center h-full">
            <div class="flex items-center md:space-x-4 space-x-2 xl:space-x-0 rtl:space-x-reverse vertical-box">
                <a href="index.html" class="mobile-logo xl:hidden inline-block">
                    ...
                    <img src="{{asset('backend/assets/images/logo/logo-c-white.svg')}}" class="white_logo" alt="logo">
                </a>
        ...
        <img src="{{asset('backend/assets/images/logo/logo.svg')}}" class="black_logo " alt="logo">
        <img src="{{asset('backend/assets/images/logo/logo-white.svg')}}" class="white_logo" alt="logo">
    </span>
      ...
      dark:bg-slate-800 border dark:border-slate-700 !top-[23px] rounded-md overflow-hidden lrt:origin-top-right rtl:origin-top-left">
                ...
                right-0 top-0"></span>
                                            <img src="/assets/images/all-img/user.png')}}" alt="user" class="block
                                            w-full h-full object-cover rounded-full border hover:border-white border-transparent">
                                        </div>
                                    </div>
                                    <div class="flex-1">
              ...
              1</span>
                ...
                right-0 top-0"></span>
                                            <img src="{{asset('backend//assets/images/all-img/user2.png')}}" alt="user"
                ...
                before:top-0 before:left-0">
                            ...
                            <div class="text-slate-600 dark:text-slate-300 block w-full px-4 py-2 text-sm  cursor-pointer">
                              ...
                              <span class="bg-green-500 w-[10px] h-[10px] rounded-full border border-white dark:border-slate-700 inline-block absolute
                right-0 top-0"></span>
                                            <img src="{{asset('backend//assets/images/all-img/user3.png')}}" alt="user"
                                             class="block w-full h-full object-cover rounded-full border hover:border-white border-transparent">
                                        </div>
                                    </div>
                                    <div class="flex-1">
                                ...
                                <div class="flex ltr:text-left rtl:text-right">
                                    <div class="flex-none ltr:mr-3 rtl:ml-3">
                                        <div class="h-8 w-8 bg-white rounded-full">
                                            <img src="{{asset('backend/assets/images/all-img/user.png')}}}}" alt="user"
              ...
              before:top-0 before:left-0">
                        ...
                        <div class="text-slate-600 dark:text-slate-300 block w-full px-4 py-2 text-sm">
                            <div class="flex ltr:text-left rtl:text-right relative">
                                <div class="flex-none ltr:mr-3 rtl:ml-3">
                                    <div class="h-8 w-8 bg-white rounded-full">
                                        <img src="{{asset('backend//assets/images/all-img/user4.png')}}" alt="user"
                                        class="border-transparent block w-full h-full object-cover rounded-full border">
                                    </div>
                                </div>
                                <div class="flex-1">
      ...
      inline-flex items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="lg:h-8 lg:w-8 h-7 w-7 rounded-full flex-1 ltr:mr-[10px] rtl:ml-[10px]">
                            <img src="{{asset('backend/assets/images/all-img/user.png')}}" alt="user" class="block
            ...
            dark:text-white font-normal">
                            ...
                            <li>
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <a href="{{route('logout')}}" class="block px-4 py-2 hover:bg-slate-100
                                    ...
                                    >
                                        ...
                                        <span class="font-Inter">{{ __('Log Out') }}</span>
                                    </a>
                                </form>
                            </li>
                        </ul>
