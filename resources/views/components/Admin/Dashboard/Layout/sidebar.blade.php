...
<div class="sidebar-wrapper group">
    ...
    <div class="sidebar-menus bg-white dark:bg-slate-800 py-2 px-4 h-[calc(100%-80px)] overflow-y-auto z-50" id="sidebar_menus">
        <ul class="sidebar-menu">
            ...
            <!-- Pages Area -->
            <li class="sidebar-menu-title">Roles & Permissions</li>
            ...
            <span>Users</span>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{route('admin.users.index')}}">All Roles</a>
                    </li>
                    <li>
            ...
            <span>Permissions</span>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="{{route('admin.permissions.create')}}">Add New</a>
                    </li>
                </ul>
            </li>
        ...
        <div class="bg-slate-900 mb-10 mt-24 p-4 relative text-center rounded-2xl text-white" id="sidebar_bottom_wizard">
            <img src="{{asset('backend/assets/images/svg/rabit.svg')}}" alt="" class="mx-auto relative -mt-[73px]">
